...
alpha=10;
beta=0.4;
bparameter = 1; % bifurcation parameter 1 = F, 2 = alpha, 3 = beta
lx = 2*pi ; % set domain length [ - lx/2 , lx/2 ]  
% Main discretization parameters
nbstepstb = 1500; % nb of steps along the trivial branch
nbstepsbb = 200; % nb of steps along the bifurcation branches
ds = 1E-3; % starting stepsize in the continuation method
nnodes = 500; % nb of nodes for the FEM discretization
...
p.sw.bifcheck =2; % enables/disable detection of bifs
