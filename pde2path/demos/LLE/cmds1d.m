...
% Fixed zeta
p = []; nx = 20; lx = 1 ; par = [1.50873,10,-0.2]; % f,zeta,d
p   = LLEinit(p,lx,nx,par); p.nc.dsmax=0.5; 
...
p = LLEinit(p,lx,nx,par); p = setfn(p,'h1D'); 
p = findbif(p,12); % many bif-points close to each other, use findbif 
