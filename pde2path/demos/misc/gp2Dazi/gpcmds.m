...
%% --------------------------------- scalar GP 
lx=4; nx=40; om=0.2; mu=3; ps=0; rs=0; m=2; % lag-multipl., phase and rot 
...
%% --------------------------------- vector GP 
close all; keep pphome; 
p=[]; lx=4; nx=30; sw.sym=2; om=0.2; mu1=2; mu2=4; ps=0; rs=0; 
par=[om mu1 ps rs mu2]; m=2; % parameters, mu2=chem.potential of 2nd compo 
