...
%% illustrate mesh-ref. 
q=loadp('q1','pt5'); % needs pffac ge 0
q.nc.bddistx=0.2;q.nc.bddisty=0.2; q=meshadac(q,'ngen',2);
%q=meshadac(q,'ngen',2);
%% generate a branch using the asymptotic approximation as an initial guess
p=nlbinit(p,lx,nx,om,kstar,1); clf(2); p.sol.ds=-0.05; p=cont(p);