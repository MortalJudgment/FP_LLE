...
%% init 
p=[]; e=0.1; k0=0.1; ga=1; R=1; bpstyle=4; m=11; s=0; mlam=0; 
cut=[-2 0.01 -2]; par=[R k0 e ga s m mlam]; % s=speed for x-PC, mc=
...
%% homogeneous branch 
p.nc.tol=1e-6; p.nc.ilam=[6 7]; p.nc.nq=1; p=cont(p,20);
%% primary pattern
