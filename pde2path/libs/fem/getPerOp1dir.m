...
if(n==1)
    ...
    for k=bp_keep
        ...
        if n==3
            k_tmp=find(abs(poi(dir_fix(1),bp_Neum)-poi(dir_fix(1),k))<tol & abs(poi(dir_fix(2),bp_Neum)-poi(dir_fix(2),k))<tol & abs(poi(dir,bp_Neum)-x2)<tol);
        end
