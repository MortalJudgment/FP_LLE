...
%
% Varargin is either empty or consists of the four inputs: start-dir,
% start-point, end-dir, end-point in this order.
%
% Parameters:
...
%
% p.oc: parameters for the whole continuation procedure
...
%   s1      - problem structure of the end point (either CSS or CPS)
...
%   verb    - verbosity 
%
% p.cp: Structure, which will contain the computed canonical path.
